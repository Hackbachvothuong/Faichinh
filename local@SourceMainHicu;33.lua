...
Ui = Window:AddTab({ Title = "Tab Config", Icon = "box" })
...
Item = Window:AddTab({ Title = "Tab Get Item", Icon = "axe" })  
...
stack = Window:AddTab({ Title = "Tab Stack Farm", Icon = "star" })
...
spl = Window:AddTab({ Title = "Tab Stats", Icon = "bar-chart-4" })
