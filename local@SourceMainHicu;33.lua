...
function TP2(Pos)
    if game.Players.LocalPlayer.Character.Humanoid.Health > 0 and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
       ...
       local itzHiru = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.PartTele, TweenInfo.new(Distance / TweenSpeed, Enum.EasingStyle.Linear), {CFrame = Pos})
       itzHiru:Play()
    end
end  
...
TextLabel.Text = "discord.gg/NQURTJs3"
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
...
infor:AddButton({
        ...
        Callback = function()
        setclipboard("https://discord.gg/NQURTJs3")
    end
})    
infor:AddButton({
...
Ui = Window:AddTab({ Title = "Tab Config", Icon = "rbxassetid://11446957539" })
...
Settings = Window:AddTab({ Title = "Tab Setting", Icon = "rbxassetid://11446835336" }) 
...
Main = Window:AddTab({ Title = "Tab Farming", Icon = "rbxassetid://11446825283" })
Main:AddParagraph({
        Title = "Main Farm",
        Content = "---------------------"
    })   
...
Mari = Window:AddTab({ Title = "Tab Farm Material", Icon = "rbxassetid://11446965348" })     
Mari:AddParagraph({
...
selectBright = Sea:AddDropdown("selectBright", {
	Title = "Select Bright",
	Values = ListBright,
	Multi = false,
	Default = BrightValue,
})
selectBright:OnChanged(function(V)
	BrightValue = V
end)
Sea:AddButton({
        Title = "Turn On Brightness",
        Description = "",
        Callback = function()            
