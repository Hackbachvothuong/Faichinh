...
setclipboard("https://discord.gg/JvScFsps") 
end)
...
BoneCheck = Mn:Label("Xương Đang Có: N/A")
    ...
    Mn:Toggle("Nhận Nhiệm Vụ Xương",true,function(V)
        _G.QuestBone = V
    end)
...
spawn(function()
    ...
    Mn:Toggle("Nhận Nhiệm Vụ Hoàng Tử Bánh",true,function(V)
        _G.QuestCake = V
    end)
